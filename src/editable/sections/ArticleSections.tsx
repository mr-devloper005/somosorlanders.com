  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-12 sm:pt-16 lg:pt-20`}>
        <div className={`rounded-[2.5rem] border ${pal.border} ${pal.darkBg} p-7 text-[var(--slot4-page-text)] shadow-[0_24px_80px_rgba(24,20,17,0.18)] sm:p-10 lg:p-14`}>
      ...
      <section className={`${dc.shell.section} ${dc.shell.sectionY}`}>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <span className={`rounded-full ${pal.darkBg} px-5 py-3 text-sm font-black text-[var(--slot4-page-text)]`}>Page {page} of {pagination.totalPages || 1}</span>
    ...
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-10 sm:pt-14 lg:pt-16`}>
        <div className={`grid gap-6 rounded-[2.5rem] border ${pal.border} bg-[var(--slot4-surface-bg)] p-6 shadow-[0_24px_80px_rgba(24,20,17,0.08)] lg:grid-cols-[minmax(0,1fr)_320px] lg:p-10`}>
          ...
          <aside className={`min-w-0 rounded-[2rem] ${pal.darkBg} p-6 text-[var(--slot4-page-text)]`}>
