...
export const taskPageVoices = {
  ...
  profile: {
    eyebrow: 'Identity',
    headline: 'Identity pages with trust and context cues.',
    description: 'Direct identity pages stay available without appearing in public discovery.',
    filterLabel: 'Filter identity category',
    secondaryNote: 'Make identity and credibility visible on direct detail pages.',
